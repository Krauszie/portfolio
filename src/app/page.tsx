        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p className="max-2-[500px] mb-9 text-white/80">
              ...
              <br />
              With 1+ years in a Japanese IT company and 1+ years collaborating
              with an Australian company, I bring a global perspective and
              strong cross-cultural collaboration skills to every project.
            </p>
            {/* <p className="max-2-[500px] mb-9 text-white/80">
