...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      p-3 text-balance font-medium ring-offset-white transition-all disabled:pointer-events-none 
      disabled:opacity-50 data-[state=active]:bg-accent data-[state=active]:text-primary 
